...
class __Mustache_b23dbf93f30ad189680d9aad51586fb5 extends Mustache_Template
{
...
';
        ...
        $buffer .= '">
';
        $buffer .= $indent . '    <div class="form-label col-sm-3 text-md-right">
';
...
';
            ...
            $buffer .= $this->section72c780137399a3730fb0bce96f20a4ea($context, $indent, $value);
            $value = $context->find('warning');
            $buffer .= $this->section10fe5cf204866d857d8d9e89890d955a($context, $indent, $value);
            $buffer .= $indent . '        </label>
';
        }
...
';
        ...
        $buffer .= $this->section95f69e203caca0242246705ac13beca1($context, $indent, $value);
        $buffer .= $indent . '        <div class="form-description mt-3 alert">';
...
';
    ...
    private function section72c780137399a3730fb0bce96f20a4ea(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
                <div class="alert alert-danger">{{override}}</div>
            ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
...
';
    ...
    private function section10fe5cf204866d857d8d9e89890d955a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section95f69e203caca0242246705ac13beca1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
            <div class="form-defaultinfo alert alert-warning {{#forceltr}}text-ltr{{/forceltr}}">{{{default}}}</div>
        ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '            <div class="form-defaultinfo alert alert-warning ';
