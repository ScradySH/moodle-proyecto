...
class __Mustache_b4494b2402515ab5b6fd44bad513dd82 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($partial = $this->mustache->loadPartial('theme_boosted/head')) {
...
';
        ...
        $buffer .= '">
';
        $buffer .= $indent . '                    <div class="login-wrapper" style="justify-content: ';
        $value = $this->resolveValue($context->find('loginboxalign'), $context);
        $buffer .= ($value === null ? '' : $value);
        $buffer .= ';">
';
