...
class __Mustache_9d8d45c03d51a73cef1bfc63c2d52c73 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '
';
        $buffer .= $indent . '<nav id="navbar-top" class="navbar fixed-top navbar-expand" aria-label="';
...
';
        ...
        $buffer .= $this->section70e1d8a11b5882b22479007738af55be($context, $indent, $value);
        $buffer .= $indent . '        ';
...
';
        $buffer .= $indent . '
';
        if ($partial = $this->mustache->loadPartial('theme_boosted/primary-drawer-mobile')) {
...
';
    ...
    private function section70e1d8a11b5882b22479007738af55be(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
            {{> theme_boosted/language_menu }}
            <div class="divider border-left h-75 align-self-center mx-1"></div>
        ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
            ...
            foreach ($values as $value) {
                ...
                if ($partial = $this->mustache->loadPartial('theme_boosted/language_menu')) {
                    $buffer .= $partial->renderInternal($context, $indent . '            ');
                }
                $buffer .= $indent . '            <div class="divider border-left h-75 align-self-center mx-1"></div>
';
