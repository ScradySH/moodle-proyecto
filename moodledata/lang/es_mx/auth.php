...
/**
 * Strings for component 'auth', language 'es_mx', version '4.3'.
 *
 * @package     auth
 * @category    string
...
$string['auth_loginrecaptcha'] = 'Habilitar reCAPTCHA para ingreso';
$string['auth_loginrecaptcha_desc'] = 'Añadir un elemento de formato de confirmación visual/auditiva a la página para ingresar al sitio. Esto reduce el  riesgo de intentos de ingreso no autorizados. Vea <a target="_blank" href="https://www.google.com/recaptcha">Google reCAPTCHA</a> para más detalles.';
