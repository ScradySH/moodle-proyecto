...
/**
 * Strings for component 'tool_uploadpage', language 'es_mx', version '4.3'.
 *
...
$string['cachedef_helper'] = 'Cacheo de ayudante de página de subida';
...
$string['invalidcsvfile'] = 'El formato del archivo es inválido.';
$string['invalidencoding'] = 'Codificación inválida especificada';
$string['invalidfileexception'] = 'El formato de archivo es inválido. {$a}';
...
$string['invalidimportfilenorecords'] = 'Sin registros en el archivo de importación.';
$string['invalidimportrecord'] = 'Registro de Importación Inválido.';
$string['invalidparentcategoryid'] = 'La categoría paterna es inválida.';
$string['pluginname'] = 'Subir cursos de página única';
...
$string['statuspagecreated'] = 'Actividad Página Creada.';
$string['statuspageupdated'] = 'Actividad Página Actualizada.';
$string['uploadpageresult'] = 'Resultados de subida';
