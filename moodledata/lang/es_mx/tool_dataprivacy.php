...
/**
 * Strings for component 'tool_dataprivacy', language 'es_mx', version '4.3'.
 *
...
$string['allowfiltering_desc'] = 'Si se habilita, el oficial de privacidad puede elegir exportar datos del usuario de cursos seleccionados en lugar de todos los  cursos. Cuando esta característica está habilitada, las solicitudes de exportación iniciarán desde \'Pendiente\' y solamente pueden ser aprobadas después de que una tarea en segundo plano haya completado.';
...
$string['approverequestall'] = 'Aprobar solicitudes (todos los datos)';
$string['approveselectedcourses'] = 'Aprobar cursos seleccionados';
...
$string['errornoselectedcourse'] = 'Usted debe seleccionar al menos un curso';
...
$string['filterexportdata'] = 'Aprobar solicitud (datos de cursos seleccionados)';
...
$string['nocoursetofilter'] = 'El usuario no está inscrito en ningún curso a seleccionar';
