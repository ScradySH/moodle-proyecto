...
/**
 * Strings for component 'theme_almondb', language 'es_mx', version '4.3'.
 *
...
$string['block20col4captiondefault'] = 'Direcc';
...
$string['block20copyrightdefault'] = 'Copyright © 2022 Diseñado por
    <a href="https://www.themealmond.com">themesalmond.com</a>.  Todos los derechos reservados.';
...
$string['brandcolor_desc'] = 'El colorfondo.';
$string['button'] = 'Botón';
$string['buttonlink'] = 'https://themesalmond.com/';
$string['choosereadme'] = 'Almondb es un tema moderno altamente personalizable.';
...
$string['frontpagenavlinkdefault'] = 'Características
-Encabezado
-Colores|/mod/page/view.php?id=113
-Bloques|/mod/page/view.php?id=114
-Fácil y rápido|/mod/page/view.php?id=115
-Use ahora|/mod/page/view.php?id=116
Pages
-Acerrca de|/mod/page/view.php?id=1
-Blog|/blog/
Cursos
-All courses|/course/
...
$string['presetfiles_desc'] = 'Los archivos de preconfiguración pueden usarse para alterar dramáticamente la apariencia del tema. Vea <a href="https://docs.moodle.org/dev/almondb_Presets">almondb presets</a> para información sobre como crear y compartir sus propios archivos de preconfiguración,  y vea <a href="https://archive.moodle.net/almondb">Presets repository</a> para preconfiguraciones que otros han compartido.';
