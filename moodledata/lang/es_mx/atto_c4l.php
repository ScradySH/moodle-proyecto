...
/**
 * Strings for component 'atto_c4l', language 'es_mx', version '4.3'.
 *
 * @package     atto_c4l
 * @category    string
...
$string['dialogtitle'] = 'Elija un componente';
$string['dodontcards'] = 'Tarjetas si/no';
$string['duedate'] = 'Fecha esperada';
$string['enableattoc4l'] = 'Habilitar Componente para aprendizaje';
...
$string['generalheading'] = 'Configuraciones generales';
...
$string['pluginname'] = 'Componentes para aprendizaje (c4l)';
