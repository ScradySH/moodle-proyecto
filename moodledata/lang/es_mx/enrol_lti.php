...
/**
 * Strings for component 'enrol_lti', language 'es_mx', version '4.3'.
 *
 * @package     enrol_lti
 * @category    string
...
<li>Cuentas existentes y nuevas (solicitud). Se le dará al usuario una opción de qué hacer. Ellos pueden decidir enlazar a una cuenta existente, o que les sea creada una cuenta nueva. Esta es la opción más flexible y la predeterminada para invocaciones de profesores.</li>
<li>Cuentas existentes solamente (solicitud). Se le pedirá al usuario que enlace a una cuenta existente y no puede acceder a los recursos de la herramienta sin hacerlo.</li>
</ul>';
