...
/**
 * Strings for component 'local_fm', language 'es_mx', version '4.3'.
 *
 * @package     local_fm
 * @category    string
...
$string['reportvariables'] = 'Incluya la variable siguiente en alguna parte de su plantilla del reporte para marcar en donde debe colocarse el bloque de retroalimentación
