...
/**
 * Strings for component 'availability_completion', language 'es_mx', version '4.3'.
 *
...
$string['cachedef_previous_cache'] = 'Información sobre dependencia con actividad anterior';
...
$string['requires_previous_not_complete_fail'] = 'La <strong>actividad anterior con finalización</strong> no está completada y está reprobada';
$string['requires_previous_not_complete_pass'] = 'La <strong>actividad anterior con finalización</strong> no está completada y está aprobada';
