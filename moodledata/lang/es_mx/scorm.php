...
/**
 * Strings for component 'scorm', language 'es_mx', version '4.3'.
 *
 * @package     scorm
 * @category    string
...
$string['completionstatusallscos'] = 'Todos los SCOs deben regresar estado de finalización';
...
$string['largetrackupgrade'] = 'El siguiente paso de actualización podría tomar un tiempo para completarse; su sitio tiene {$a} registros de seguimiento de SCORM que necesitan ser migrados a la nueva estructura de la tabla; por favor sea paciente porque no se puede mostrar una barra de progreso.';
...
$string['privacy:metadata:scorm_attempt'] = 'Los intentos de SCORM hechos por un usuario';
