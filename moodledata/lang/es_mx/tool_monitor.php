...
/**
 * Strings for component 'tool_monitor', language 'es_mx', version '4.3'.
 *
...
$string['messagetemplate_help'] = 'Se envía un mensaje de notificación a los suscriptores una vez que se alcance el umbral para notificación. El mensaje puede incluir alguno de, los siguientes remplazables (\'\'placeholders\'\'):

* Enlace al lugar donde ocurrió el evento {link}
* Enlace al área monitoreada {modulelink}
