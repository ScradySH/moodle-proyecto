...
/**
 * Strings for component 'backup', language 'es_mx', version '4.3'.
 *
 * @package     backup
 * @category    string
...
$string['backupautoactivitiesdescription'] = 'Configura lo predeterminado para incluir actividades en un respaldo. Para que funcione la papelera de reciclaje, esta configuración necesita estar habilitada.';
...
$string['configgeneralxapistate'] = 'Configurar lo predeterminado para incluir en el estado del usuario como por ejemplo actividades H5P en un respaldo.';
...
$string['configrestorexapistate'] = 'Configurar lo predeterminado para restaurar el estado del usuario en contenido como por ejemplo actividades H5P.';
...
$string['errorrestorefrontpagebackup'] = 'Usted solamente puede restaurar los respaldos de la página de inicio del sitio';
...
$string['generalxapistate'] = 'Incluir estado del usuario en contenido como por ejemplo actividades H5P';
...
$string['questioncannotberestored'] = 'La restauración no puede crear las preguntas  "{$a->name}"';
$string['recyclebin_desc'] = 'Tenga en cuenta que estas configuraciones también serán usadas para la papelera de reciclaje';
...
$string['restoreexecutionsuccess'] = 'El curso fue restaurado exitosamente.,';
...
$string['rootsettingxapistate'] = 'Incluir estado del usuario en contenido como por ejemplo actividades H5P';
...
$string['sitecourseformatwarning'] = 'Este es un respaldo de la página de inicio del sitio. Solamente puede ser restaurado en la página de inicio del sitio.';
