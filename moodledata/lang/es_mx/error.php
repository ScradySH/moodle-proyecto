...
/**
 * Strings for component 'error', language 'es_mx', version '4.3'.
 *
 * @package     error
 * @category    string
...
$string['dndunkownfile'] = 'Este tipo de archivo no está soportado';
$string['dndupload'] = 'Ocurrió un error al subir el archivo';
...
$string['editedpagenotfound'] = 'El sistema no puedo determinar la página en la que está usted. Por favor refresque la página e inténtelo de nuevo.';
...
$string['invalidcoursemoduleid'] = 'ID de módulo de curso inválida: {$a}';
...
$string['missingcategoryrole'] = 'No se pudo asignar rol a usuario: rol faltante para categoría.';
...
$string['moodlenet:invalidshareformat'] = 'Formato inválido de compartición MoodleNet';
$string['moodlenet:invalidsharestatus'] = 'Estado de compartición MoodleNet inválido';
$string['moodlenet:invalidsharetype'] = 'Tipo de compartición MoodleNet inválido';
$string['moodlenet:usernotconfigured'] = 'Usted no tiene permiso para compartir contenido a MoodleNet, o su cuenta está incorrectamente configurada.';
...
$string['opensslsignerror'] = 'OPENSSL no puede firmar los datos';
...
$string['passwordexceeded'] = 'La contraseña no puede ser de más de {$a} caracteres';
...
$string['sessioncannotobtainlock'] = '<p>No se pudo obtener el bloqueo para sesión con ID {$a->id} dentro de {$a->acquiretimeout}.</p>
<p>Es probable que otra página ({$a->whohaslock}) aun esté ejecutándose en otra pestaña del navegador, o que no se liberó el bloqueo por un error.</p>
<p>Usted puede esperar a que caduque el bloqueo de la sesión ({$a->lockexpire}) o usted puede reiniciar su sesión del navegador. Si este error persiste, por favor póngase en contacto con el administrador del servidor.</p>';
...
$string['unknowncategory'] = 'Categoría desconocida con número ID de categoría "{$a}"';
...
$string['userisfilteredout'] = '¡El usuario no coincide con filtros y preferencias de tabla!';
