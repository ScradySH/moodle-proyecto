...
/**
 * Strings for component 'grouptool', language 'es_mx', version '4.3'.
 *
 * @package     grouptool
 * @category    string
...
$string['calendaravailable'] = '{$a} registro abre';
$string['calendardue'] = '{$a} registro está pendiente';
...
$string['cfg_show_add_info'] = 'Mostrar información adicional del grupo en auto registro';
$string['cfg_show_add_info_desc'] = 'Mostrar información adicional de grupos Moodle, como por ejemplo descripciones o imágenes en  la pestaña para registro';
...
$string['open_group_message'] = 'Abrir mensajes de  grupo';
...
$string['queuesizeerror'] = 'Los lugares en cola deben ser un número entero y mayor o igual a 0. No están permitidas letras ni otros signos.';
