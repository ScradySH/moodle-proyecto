...
/**
 * Strings for component 'local_cnw_smartcohort', language 'es_mx', version '4.3'.
 *
...
$string['addrule'] = 'Crear nueva regla';
$string['affect_need_initialize'] = '';
$string['affected_users'] = 'Usuarios afectados';
$string['all_users'] = 'Todos los usuarios';
$string['and_if'] = 'y el valor del campo  <i>\'{$a}\'</i>';
$string['anyfield'] = 'Cualquier perfil personalizado';
$string['basic_data'] = 'Datos básicos';
$string['cnw_smartcohort:manage'] = 'Gestionar Cohorte Inteligente';
$string['cohort'] = 'Cohorte';
$string['create_rule'] = 'Crear regla';
$string['delconfirm'] = '¿Realmente desea eliminar la regla \'{$a}\'?';
$string['delconfirm_keep'] = 'Conservar inserciones de cohorte';
$string['delconfirm_keep_desc'] = 'al presionar el botón se conservan los usuarios que hayan sido añadidos a una cohorte por la regla en la cohorte.';
$string['delconfirm_undo'] = 'Deshacer inserciones de cohorte';
$string['delconfirm_undo_desc'] = 'al presionar este botón se quitan los usuarios que hayan sido añadidos a una cohorte exclusivamente debido a esta regla (y que ninguna otra regla se aplique a ellos) de la cohorte.';
...
$string['deleting'] = 'La regla está siendo eliminada ...';
$string['delrule'] = 'Eiminar regla';
...
$string['if'] = 'Si el valor del campo  <i>\'{$a}\'</i>';
$string['initialize_rule_cron'] = 'Inicializar reglas';
$string['initialized'] = 'Inicializados';
$string['name'] = 'Nombre';
$string['no'] = 'en progreso';
$string['no_data'] = 'Sin reglas disponibles';
...
$string['rule_is_not_exist'] = 'La regla no existe';
$string['rules'] = 'Reglas';
$string['to'] = 'hacia';
