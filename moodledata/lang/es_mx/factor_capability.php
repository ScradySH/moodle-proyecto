...
/**
 * Strings for component 'factor_capability', language 'es_mx', version '4.3'.
 *
...
$string['capability:cannotpassfactor'] = 'DETENER a un rol de pasar el factor de capacidad del usuario MFA.';
