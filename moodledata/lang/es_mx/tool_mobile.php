...
/**
 * Strings for component 'tool_mobile', language 'es_mx', version '4.3'.
 *
 * @package     tool_mobile
 * @category    string
...
$string['autologout'] = 'Aplicar auto salida del sitio para sus usuarios';
$string['autologout_desc'] = 'Por razones de seguridad, usted puede forzar salida del sitio  automática para sus usuarios cuando ellos dejan o cierran la App, o regresa a segundo  plano. Los usuarios tendrán que ingresar al sitio nuevamente cuando retornen a la App.';
$string['autologoutcustom'] = 'Tiempo personalizado después de que los usuarios dejan o cierran la App';
$string['autologoutinmediate'] = 'Inmediatamente después de que los usuarios dejan o cierran la App.';
$string['autologouttime'] = 'Cronómetro de auto salida';
