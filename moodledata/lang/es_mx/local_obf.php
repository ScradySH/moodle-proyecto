...
/**
 * Strings for component 'local_obf', language 'es_mx', version '4.3'.
 *
 * @package     local_obf
 * @category    string
...
$string['newbadgeearned'] = '<b>{$a->courselink}</b><br><hr><br>Usted ganó una nueva insignia: <b>{$a->badgelink}</b><br><br>Por favor revis su correo electrónico para más información';
